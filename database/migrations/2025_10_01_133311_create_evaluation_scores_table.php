...
return new class extends Migration
{
    ...
    {
        Schema::create('evaluations_scores', function (Blueprint $table) {
            $table->id();
            ...
            // Ensure only one evaluation per student per evaluator type per evaluation (and per evaluator for peer evaluations)
            $table->unique(['evaluation_id', 'student_id', 'evaluator_type', 'evaluator_id'], 'unique_evaluation');
        });
    }
    ...
    {
        Schema::dropIfExists('evaluations_scores');
    }
};
