    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">
                Peer Evaluation - {{ $organization->name ?? 'N/A' }}
            </h2>
            ...
            <div class="mt-4 p-4 bg-yellow-50 rounded-lg">
                <p class="text-sm text-yellow-800">
                    <strong>Instructions:</strong> Please evaluate your peer honestly based on their leadership performance in this organization. Your responses will contribute to their final leadership ranking.
                </p>
            </div>
        </div>
        ...
        <form wire:submit="save">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="overflow-x-auto">
                    ...
                    <tbody>
                        @php
                            $groupedQuestions = $this->groupQuestions(\App\Models\Evaluation::getPeerQuestionsForStudents());
                        @endphp
